...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      secondaryFixed: Color(0xffffe08d),
      onSecondaryFixed: Color(0xff241a00),
      secondaryFixedDim: Color(0xffe3c36c),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      secondary: Color(0xff534000),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff8b7223),
      ...
      secondaryFixed: Color(0xff8b7223),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff715909),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff534000),
      onSecondaryContainer: Color(0xffffffff),
      ...
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff534000),
      onSecondaryFixed: Color(0xffffffff),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      secondaryContainer: Color(0xffe8c870),
      onSecondaryContainer: Color(0xff000000),
      ...
      secondaryFixed: Color(0xffffe5a1),
      onSecondaryFixed: Color(0xff000000),
      secondaryFixedDim: Color(0xffe8c870),
